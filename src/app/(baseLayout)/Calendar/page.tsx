...
import { RootState, useAppDispatch, useAppSelector } from '@/store/index'; // 수정된 부분
import { setSelectedDate } from "@/store/dateStore";
import dayjs from 'dayjs';

export default function MyPageLayout({ children }: { children: any }) {
  const selectedStoreDate = useSelector((state: RootState) => state.dateStore.selectedDate);
